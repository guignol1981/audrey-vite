<template>
    <div class="bg-white">
        <section
            ...
            class="mx-auto max-w-7xl py-12 sm:px-2 lg:px-8"
        >
            <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                <div class="max-w-3xl">
                    ...
                    <p class="mt-4 text-gray-500">
                        ...
                        elit. Nostrum, ad! Dolore quae maxime ipsum illo.
                        Quisquam sapiente unde quo est eaque! Placeat dicta
                        quibusdam minima perspiciatis voluptates consectetur,
                        quam cum!
                    </p>
                </div>
                ...
                <TabGroup as="div" class="mt-4">
                    <div class="-mx-4 flex overflow-x-auto sm:mx-0">
                        <div
                            class="flex-auto border-b border-gray-200 px-4 sm:px-0"
                        >
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="lg:col-span-7">
                                    <div
                                        class="aspect-w-2 aspect-h-1 sm:aspect-w-5 sm:aspect-h-2 overflow-hidden rounded-lg bg-gray-100"
                                    >
                                        <img
