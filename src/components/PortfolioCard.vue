    ...
    >
        ...
        >
            <a
                ...
                href="#"
                class="translate-y-full rounded-md border border-white py-2 px-3 text-2xl tracking-wider backdrop-blur-md backdrop-brightness-110 transition hover:scale-105 group-hover:translate-y-0"
